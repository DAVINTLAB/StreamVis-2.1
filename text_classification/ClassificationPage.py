...
def classification_page():
    st.title("Toxicity Detection and Sentiment Analysis")
    ...
    # Remove colunas de toxicidade, sentimento e scream_index se já existirem
    ...
    if st.button("Run Classification"):
        with st.spinner("Analysing toxicity and sentiment..."):
        ...
        st.download_button(
            ...
            data=json_resultado,
            file_name="resultado_completo.json",
